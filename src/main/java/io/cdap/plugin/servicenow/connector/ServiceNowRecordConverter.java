...
public class ServiceNowRecordConverter {
  ...
  public static Double convertToDoubleValue(String fieldValue, String fieldName) {
    try {
      ...
      throw new UnexpectedFormatException(
        String.format("Field '%s' with value '%s' is not in valid format.", fieldValue, fieldName), exception);
    }
  }
  ...
  public static Boolean convertToBooleanValue(String fieldValue, String fieldName) {
    ...
    throw new UnexpectedFormatException(
      String.format("Field '%s' with value '%s' is not in valid format.", fieldValue, fieldName));
